knitr::opts_chunk$set(output = "html_document")
...
ggplot(data = hotel_bookings) +
  ...
  facet_wrap(~hotel)
  ggsave("market_segment_facet_0.png")
```
...
ggplot(data = hotel_bookings) +
  geom_bar(mapping = aes(x = market_segment)) +
  facet_wrap(~hotel) +
  labs(title="hotel booking title here")
  ggsave("market_segment_facet.png")
```
...
ggplot(data = hotel_bookings) +
  ...
  labs(title="Comparison of market segments by hotel type for hotel bookings",
   ...
   ggsave("market_segment_facet_1.png")
```
...
ggplot(data = hotel_bookings) +
  ...
  labs(title="Comparison of market segments by hotel type for hotel bookings",
       ...
       ggsave("market_segment_facet_2.png")
```
...
ggplot(data = hotel_bookings) +
  ...
  labs(title="Comparison of market segments by hotel type for hotel bookings",
       ...
       ggsave("market_segment_facet_3.png")
```
...
```{r save your plot}
ggsave('hotel_booking_chart9_4.png')
```
...
```{r save your plot}
ggsave('hotel_booking_chart_4.png',
       width=25,
       height=25)
```
